    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          <tr><td style='background-color:#" + hexColor + ";'>" + data[i]['Cliente_c01_F0FFF0'] + "</td><td>" + data[i]['produto'] + "</td><td>" + data[i]['data_entrega_prevista'] + "</td><td>" + data[i]['data_entrega_real'] + "</td></tr>");
        }
      }
    });
  }
